...
get_flow_acc_vals <- function(aoi, stream_raw, flow_acc_raw){
  # aoi = filter(case_hybas_tbl_unnest, id == "na_7060000010")
  # aoi = filter(case_hybas_tbl_unnest, id == "af_1061451560") #problematic one
...
#   # aoi = filter(case_hybas_tbl_unnest, id == "na_7060000010")
#   # aoi = filter(case_hybas_tbl_unnest, id == "au_5060077570")
#   # aoi = filter(case_hybas_tbl_expand, id == "au_5060081550") #fail
...
#   # === Extract Flow Accumulation values for the AOI === #
